            ...
            {slides.map((slide, index) => (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/precos" className="bg-primary text-white hover:bg-secondary px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all hover:scale-105 shadow-2xl text-center">
                    Garantir meu Plano
                  </Link>
                  <Link to="/trabalhos" className="bg-gray-100 text-primary hover:bg-gray-200 px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all text-center">
                    Ver Portfólio
                  </Link>
                </div>
              </div>
            ...
            <div className="relative w-full max-w-[650px] h-full">
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  <img src={slide.image} alt={slide.title} className={`relative z-10 w-full h-full object-contain drop-shadow-2xl ${index === 0 ? 'scale-110' : 'scale-100'}`} />
                  <div className="absolute -bottom-6 -right-6 md:right-0 bg-white p-6 rounded-[2rem] shadow-2xl z-20 border border-gray-100 animate-bounce-slow">
                    <div className="flex items-center gap-4">
                      <div className={`${slide.accent}/10 p-3 rounded-2xl text-primary`}>
